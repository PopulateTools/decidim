...
//   decidim-forms/app/views/decidim/forms/questionnaires/answers/_files.html.erb
  ...
  <div class="js-radio-button-collection">
    ${options.map((opt) => `
      <div class="js-collection-input">
        ...
        <input name="questionnaire[responses][${qid}][answer_option_id]" type="hidden" value="${opt.optionId}" />
      </div>
    `).join("")}
  </div>
`;
...
// Mirrors answers/_sorting.html.erb
  ...
  <div class="answer-questionnaire__sorting-container js-sortable-check-box-collection">
    ${[["10", "1"], ["11", "2"], ["12", "3"]].map(([optId, pos], idx) => `
      <div class="answer-questionnaire__sorting js-collection-input" role="button">
        ...
        <input type="hidden" name="questionnaire[responses][${qid}][choices][${idx}][answer_option_id]" value="${optId}" />
      </div>
    `).join("")}
  </div>
`;
...
const page = () => `
  <form class="answer-questionnaire" data-safe-path="/f">
